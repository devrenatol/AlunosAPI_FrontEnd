...
export default function NovoAluno(){
    ...
    async function loadAluno(){
        try{
            ...
            const response = await api.get(`api/v1/alunos/${alunoId}`, authorization);
    ...
    async function saveOrUpdate(event){
        ...
        try{
            ...
            if(alunoId === '0'){
                await api.post('api/v1/alunos', data, authorization);
            }
            else{
                data.id = id;
                await api.put(`api/v1/alunos/${id}`, data, authorization);
            }
